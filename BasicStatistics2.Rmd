...
XXX.Rmd Also, if you want to know where R studio is saving files use the following command.  Click on the right greeen arrow to run this chunk of code.
...
### Student's t distribution Part 3
...
### Student's t distribution Part 5
...
### Student's t distribution Part 6
...
Were the results what you expected for (a) and (b)?  Why or why not?
...
## 4. CRD Anova
#### Part 1. Inspection and summary of data
...
#### Part 2. ANOVA using R functions
...
#### Part 3. Confidence intervals for treatment means
...
#### Part 3. Analyzing least significant difference (LSD) for treatments
...
#### Part 3. Make a 95% confidence interval for the estimation of the slope.
...
#### Part 4. Make a 95% confidence interval for mean heart weight at a given body weight.

...
Does the variance of milk production differ between the two herds (Herd1 vs. Herd2)? Perform a test of hypothesis at the 5% level ($\alpha = 0.05$) using the F-statistic. Look up the critical F value by using the qf(p = 0.05/2, df1 = , df2 = ) function.

Use the var.test () R function to test for difference of variances.
